    ...
    def process_batch(
        ...
        with torch.set_grad_enabled(is_train), accelerator.autocast():
            noise_pred = self.call_unet(
                ...
                timesteps,
                [text_embeddings],  # Wrap in list for compatibility
                batch,
                weight_dtype,
            )
...
def main():
    ...
    parser.add_argument("--network_dim", type=int, default=32, help="LoRA network dimension")
    parser.add_argument("--network_alpha", type=float, default=32, help="LoRA network alpha")
